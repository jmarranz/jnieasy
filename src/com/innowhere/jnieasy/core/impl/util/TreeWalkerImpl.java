...
/*
 * Se ha copiado (y retocado) el código de Xerces para evitar tener que meter el 
 * Xerces completo.
 */
...
public class TreeWalkerImpl implements TreeWalker {
    ...
    // jmarranz private boolean fUseIsSameNode;
    ...
    public TreeWalkerImpl(Node root, 
        ...
        fCurrentNode = root;
        fRoot = root;
        // jmarranz fUseIsSameNode = useIsSameNode(root);
