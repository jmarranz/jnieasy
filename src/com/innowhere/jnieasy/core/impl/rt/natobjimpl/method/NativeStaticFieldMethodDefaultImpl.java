...
public class NativeStaticFieldMethodDefaultImpl extends NativeFieldMethodDefaultImpl implements NativeStaticFieldMethod
{
    private static final long serialVersionUID = 1L; // Para asegurar que la serialización/deserialización no cambia aunque se recompile la clase y se añadan nuevos métodos
    
    public NativeStaticFieldMethodDefaultImpl() 
    {
    }   
    ...
    {
        return new NativeStaticFieldMethodDefaultImpl();
    }
    
    public Object[] jnieasyNewArrayInstance(int len)
    {
        return new NativeStaticFieldMethodDefaultImpl[len];
    }     
