/*
 * NativeDirectStaticFieldCallbackImpl.java
 *
...
public abstract class NativeDirectStaticFieldCallbackImpl extends NativeDirectFieldCallbackImpl implements NativeDirectStaticFieldCallback
{
    private static final long serialVersionUID = 1L; // Para asegurar que la serialización/deserialización no cambia aunque se recompile la clase y se añadan nuevos métodos
    
    /**
     * Creates a new instance of NativeDirectStaticFieldCallbackImpl
     */
    public NativeDirectStaticFieldCallbackImpl()
    {
    }    
    ...
    {
        return jnieasyOnCall(opcode,value);
    }
    
    public abstract Object jnieasyOnCall(int opcode,Object value);
}
