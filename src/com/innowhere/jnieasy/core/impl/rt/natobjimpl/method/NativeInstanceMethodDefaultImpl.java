...
public class NativeInstanceMethodDefaultImpl extends NativeMethodDefaultImpl implements NativeInstanceMethod
{
    private static final long serialVersionUID = 1L; // Para asegurar que la serialización/deserialización no cambia aunque se recompile la clase y se añadan nuevos métodos
    
    public NativeInstanceMethodDefaultImpl() 
    {
    }
    ...
    {
        return new NativeInstanceMethodDefaultImpl();
    }   
    
    public Object[] jnieasyNewArrayInstance(int len)
    {
        return new NativeInstanceMethodDefaultImpl[len];
    }     
