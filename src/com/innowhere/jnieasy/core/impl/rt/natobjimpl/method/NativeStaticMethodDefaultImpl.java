...
public class NativeStaticMethodDefaultImpl extends NativeMethodDefaultImpl implements NativeStaticMethod
{
    private static final long serialVersionUID = 1L; // Para asegurar que la serialización/deserialización no cambia aunque se recompile la clase y se añadan nuevos métodos
    
    public NativeStaticMethodDefaultImpl() 
    {
    }   
    ...
    {
        return new NativeStaticMethodDefaultImpl();
    }    
    
    public Object[] jnieasyNewArrayInstance(int len)
    {
        return new NativeStaticMethodDefaultImpl[len];
    }     
