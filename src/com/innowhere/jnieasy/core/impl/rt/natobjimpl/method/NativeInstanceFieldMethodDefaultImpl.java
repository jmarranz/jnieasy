/*
 * NativeInstanceFieldMethodReflectionImpl.java
 *
 * Created on 1 de diciembre de 2004, 17:48
 */

package com.innowhere.jnieasy.core.impl.rt.natobjimpl.method;
import com.innowhere.jnieasy.core.impl.rt.natobjimpl.method.NativeFieldMethodDefaultImpl;
...
public class NativeInstanceFieldMethodDefaultImpl extends NativeFieldMethodDefaultImpl implements NativeInstanceFieldMethod
{
    private static final long serialVersionUID = 1L; // Para asegurar que la serialización/deserialización no cambia aunque se recompile la clase y se añadan nuevos métodos
    
    /**
     * Creates a new instance of NativeInstanceFieldMethodReflectionImpl
     */
    public NativeInstanceFieldMethodDefaultImpl()
    {
    }
    ...
    {
        return new NativeInstanceFieldMethodReflectionImpl();
    }      
    
    public Object[] jnieasyNewArrayInstance(int len)
    {
        return new NativeInstanceFieldMethodReflectionImpl[len];
    }     
