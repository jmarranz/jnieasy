/*
 * JavaClassAsNativePointerImpl.java
 *
 ...
 * @author jmarranz
 */
public class JavaClassAsNativePointerImpl extends JavaClassAsNativeObjectFieldContainerImpl
{
    
    /**
     * Creates a new instance of JavaClassAsNativePointerImpl
     */
    public JavaClassAsNativePointerImpl(ClassTypeNativePointerCustomImpl classType)
    {
        super(classType);
    }
    ...
    {
        return new JavaClassAsNativePointerEnhancer(this,ctx);
    }     
}
