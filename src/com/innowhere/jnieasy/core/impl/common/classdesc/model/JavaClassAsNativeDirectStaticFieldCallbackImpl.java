/*
 * JavaClassAsNativeDirectStaticFieldCallbackImpl.java
 *
 ...
 * @author jmarranz
 */
public class JavaClassAsNativeDirectStaticFieldCallbackImpl extends JavaClassAsNativeDirectFieldCallbackImpl
{
    
    /** Creates a new instance of JavaClassAsNativeDirectStaticFieldCallbackImpl */
    public JavaClassAsNativeDirectStaticFieldCallbackImpl(ClassTypeNativeDirectStaticFieldCallbackCustomImpl classType)
    {
        super(classType);
    }
    ...
    {
        return new JavaClassAsNativeDirectStaticFieldCallbackEnhancer(this,ctx);
    }
