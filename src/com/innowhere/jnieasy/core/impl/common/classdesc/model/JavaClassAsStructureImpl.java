 ...
 * @author jmarranz
 */
public class JavaClassAsStructureImpl extends JavaClassAsNativeSeparatedFieldContainerImpl
{
    
    /**
     * Creates a new instance of JavaClassAsStructureImpl 
     */
    public JavaClassAsStructureImpl(ClassTypeStructureCustomImpl classType)
    {
        super(classType);
    }
    ...
    {
        return new JavaClassAsStructureEnhancer(this,ctx);
    }   
}
