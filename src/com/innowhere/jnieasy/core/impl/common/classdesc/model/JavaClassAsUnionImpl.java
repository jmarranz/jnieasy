 ...
 * @author jmarranz
 */
public class JavaClassAsUnionImpl extends JavaClassAsNativeMultipleFieldContainerImpl
{
    
    /**
     * Creates a new instance of JavaClassAsUnionImpl 
     */
    public JavaClassAsUnionImpl(ClassTypeUnionCustomImpl classType)
    {
        super(classType);
    }
    ...
    {
        return new JavaClassAsUnionEnhancer(this,ctx);
    }    
