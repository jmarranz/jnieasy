/*
 * VarTypeNativeCallbackDefaultImpl.java
 *
...
import com.innowhere.jnieasy.core.impl.rt.vartypedec.natobj.VarTypeNativeCallbackDefaultRuntimeImpl;
 ...
 * @author jmarranz
 */
public class VarTypeNativeCallbackDefaultImpl extends VarTypeNativeCapableImpl
{
    
    /**
     * Creates a new instance of VarTypeNativeCallbackDefaultImpl
     */
    public VarTypeNativeCallbackDefaultImpl(TypeNativeCallbackDefaultImpl typeDec)
    {
        super(typeDec);
    }
    ...
    {
        return new VarTypeNativeCallbackDefaultRuntimeImpl(this,(TypeNativeCallbackDefaultRuntimeImpl)typeDecRt);
    }   
}
