 ...
 * JNIEnv.java
 *
 * Created on 29 de enero de 2004, 16:59
 */
 ...
 * @author  jmarranz
 */
/* NO SE USA, ES EXPERIMENTAL, un intento de usar llamadas JNI desde Java
 */

public class JNIEnv
{
    
    /** Creates a new instance of JNIEnv */
    public JNIEnv()
    {
    }

    //jint CallIntMethod(jobject obj, jmethodID methodID, ...);    
    public static native int getAddressCallIntMethod();  // NO SE USA ES UNA PRUEBA
    
    
    // jobject NewGlobalRef(jobject lobj);
    public static native int NewGlobalRef(Object lobj);
    
    // void DeleteGlobalRef(jobject gref);    
    public static native void DeleteGlobalRef(int gref);   
    
    //const char* GetStringUTFChars(jstring str, jboolean *isCopy);
    public static native int GetStringUTFChars(String str);
    
    //void ReleaseStringUTFChars(jstring str, const char* chars); 
    public static native void ReleaseStringUTFChars(String str, int chars);    
}


/* Tomado de jni.h  (v 1.4) definido __cplusplus
 se han quitado las implementaciones y se ha dejado como la 
